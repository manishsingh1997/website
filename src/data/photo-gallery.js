    ...
    categoryGroups: [
      ...
      },
      {
        ...
        groupPhotos: [
          ...
          {
            'caption': "Alameda, CA - Picture Frame Board on Board with 1' Diagonal Privacy Lattice on Reinforced Concrete Block Retaining Wall",
          ...
          {
            'caption': " Belmont, CA - Picture Frame Board on Board with Diagonal Lattice and an integrated 3' Retaining Wall",
          ...
          {
            'caption': "San Jose, CA -  Picture Frame Board on Board with Diagonal Lattice and an integrated 1' Retaining Wall",
    ...
    categoryGroups: [
      {
        ...
        groupPhotos: [
          ...
          {
            'caption': "Oakland, CA - Nail Up Side by Side Dog Ear with 3 rails, and Nail Up Side by Side Dog Ear with an Integrated 3' Tall Retaining Wall",
    ...
    categoryGroups: [
      {
        ...
        groupPhotos: [
          {
            'title': 'Stairs',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c0943632862dd3c8445726a_brushed_16.jpg',
            'slug': 'brushed-concrete-stair-2',
          },
          {
            'title': 'Driveways',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c09434f8aad60431d108d9c_brushed_15.jpg',
            'slug': 'brushed-concrete-driveway-4',
          },
          {
            'title': 'Patios',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094327a482fe68a2b13ad4_brushed_14.jpg',
            'slug': 'brushed-concrete-patio',
          },
          {
            'title': 'Walkways',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c0942fe7fe166528130f4e9_brushed_13.jpg',
            'slug': 'brushed-concrete-walkway',
          },
          {
            'title': 'Utility Areas',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c0942cc368c332a9c9dda24_brushed_12.jpg',
            'slug': 'brushed-concrete-utility-area',
          },
          {
            'title': 'Curbs',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c0942b73ae9453f15da1a02_brushed_1.jpg',
            'slug': 'brushed-concrete-curb',
          },
        ],
      },
      {
        ...
        groupPhotos: [
          {
            ...
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef42fe6add22891a0cf62c_stampstained9.jpg',
            'slug': 'stamped-and-stained-concrete-flagstone',
            'description': 'Natural flagstone stamp on colored concrete. Offers the looks of natural stone but without the hefty price tag. The stamp can be applied over any number of colors to achieve the desired look. Also looks great on medium to large driveways.',
          },
          {
            'title': 'Ashlar Slate Stamp',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef42d260911a411f5469f8_stampstained8.jpg',
            'slug': 'stamped-and-stained-concrete-ashlar-slate',
            'description': 'Slate ashlar pattern stamp with dark gray colored concrete. Integrates a natural texture with an interesting casual pattern. This stamp looks great on driveways, walkways and patios.',
          },
          {
            'title': 'Seamless Slate Stamp',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef4284df7c09523b2be42a_stampstained7.jpg',
            'slug': 'stamped-and-stained-concrete-seamless-slate',
            'description': 'Seamless slate stamp with dark gray colored concrete. Look is natural, simple and yet interesting. Works best with large driveways where pavers might not be a viable option or for homes in a natural setting',
          },
        ],
      },
      {
        groupName: 'Traditional',
        groupSlug: 'traditional',
        groupPhotos: [
          {
            'title': 'Traditional Brick Pattern',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef425c60911a6d295469e1_stampstained6.jpg',
            'slug': 'stamped-and-stained-concrete-herringbone',
            'description': 'Another traditional brick pattern that looks great on concrete is the herringbone stamp. Works on a variety of different colors and with many different home styles, although it is most popular with traditional or more formal homes.',
          },
          {
            'title': 'Running Bond Pattern',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef423260911a0b375469d6_stampstained5.jpg',
            'slug': 'stamped-and-stained-running-bond',
            'description': "The traditional feel of a running bond pattern is a true classic. This pattern works best with colonial and tudor style homes. It's gorgeous with a darker colored concrete and with a nice band, is almost mistakable for rounded edge brick.",
          },
          {
            'title': 'European Fan Pattern',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef4203b7d3e950ef67e417_stampstained4.jpg',
            'slug': 'stamped-and-stained-concrete-outback-european-fan',
            'description': 'Perhaps you like the look of pavers in a European Fan pattern but prefer a more budget-friendly option. If so, this elegant stamp on colored concrete is a perfect solution.',
          },
        ],
      },
      {
        ...
        groupPhotos: [
          {
            'title': 'Modern Plank Stamp',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c3e545b7e2ca21d36af0162_stamped%2520mod114.jpg',
            'slug': 'plank-stamp-concrete',
            'description': 'If you like the idea of pouring concrete instead of installing pavers, but desire a textured and linear look, the plank stamp is a great option. Pair it with a rich grey or warm tone for best results.',
          },
          {
            'title': 'Square Tile Slate Stamp',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef41c9486e7fe0a0d5f7ac_stampstained3.jpg',
            'slug': 'stamped-and-stained-concrete-gray-and-outback-square-tile',
            'description': "When a modern look is desired with a bit of texture added, this square tile slate stamp is a good solution. It's a great combination of sleek minimalism and natural stone texture and works with a variety of cool and warm color tones.",
          },
          {
            'title': 'Large Running Bond Stamp',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5bef4154df7c0974212be3da_stampstained.jpg',
            'slug': 'stamped-and-stained-concrete-dark-gray-running-bond',
            'description': 'The large running bond is a cool new option for stamping and scoring colored concrete. This look is super clean- an easy way to achieve a modern driveway.',
          },
        ],
      },
    ],
    ...
    categoryGroups: [
      {
        ...
        groupPhotos: [
          {
            price: 1,
            'title': 'Basalite Artisan Slate',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094a74e4eab1db7ea9e299_paver_13.png',
            'slug': 'paver-artisan-slate-manufacturer-basalite',
            'description': "Basalite makes a unique textured paver called Artisan Slate that has darker cool and warm shades. It's our most affordable paver but doesn't lack in the interest and reliability departments.",
          },
          {
            price: 2,
            'title': 'Belgard Victorian Avalon Slate',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094a642862dd2c9845782d_paver_12.png',
            'slug': 'paver-avalon-slate',
            'description': 'When a more warm and neutral color scheme is preferred, the Belgard paver in Victorian Avalon Slate is perfect. These pavers work great for homes of any style and are a mid-range priced paver.',
          },
          {
            price: 3,
            'title': 'Calstone Antiqued Mission Pavers',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094a547b382013ecaba17e_paver_1.png',
            'slug': 'pavers-calstone-pinwheel-pattern',
            'description': 'This driveway consists of a fun pinwheel pattern with Calstone Antiqued Mission pavers in Gray Charcoal. Calstone pavers are extremely durable and come in a large range of colors. This particular pattern keeps the vibe casual and interesting.',
          },
        ],
      },
      {
        ...
        groupPhotos: [
          {
            price: 1,
            'title': 'Basalite Italian Renaissance',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094bcda482fe3570b14d24_paver_tradition3.png',
            'slug': 'paver-italian-renaissance-manufacturer-basalite',
            'description': "If you like the look of cobble, but need a smoother surface, Basalite's Italian Renaissance paver is a great choice. Shown here in a vibrant mix of colors, it's charming and economical.",
          },
          {
            price: 2,
            'title': 'Belgard Old World',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094b52a482fe40a7b14cf7_paver_tradition2.png',
            'slug': 'paver-old-world-manufacturer-belgard',
            'description': 'A true rustic look can be easily accomplished with the Belgard Old World pavers. The wider gap and natural surface with cool colored stone work great with traditional style homes in urban or rural settings.',
          },
          {
            price: 3,
            'title': 'Calstone Belgian Stone',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c094b1ba482fe7a2ab14cd0_paver_tradition.png',
            'slug': 'paver-running-bond-manufacturer-calstone',
            'description': "For the quintessential traditional paver, Calstone's Belgian Stone wins in its class. A muted gray color with lovely rounded edges reinforces the grace and timelessness of the individual stones.",
          },
        ],
      },
      {
        ...
        groupPhotos: [
          {
            price: 1,
            'title': 'Basalite Plank',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c2d0bb6bead1e7e7582328a_paver%2520mod1.jpg',
            'slug': 'paver-plank-manufacturer-basalite',
            'description': 'Basalite has created an economical solution for achieving a modern look for your driveway or patio. The Plank Paver is a great option for a large space on a tight budget. This paver can be ordered in darker or lighter gray shades to suit your preferences.',
          },
          {
            price: 2,
            'title': 'Belgard Melville Plank',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c2d0d97bead1e28fd823426_paver%2520mod2.jpg',
            'slug': 'paver-melville-plank-manufacturer-belgard',
            'description': 'For a clean, modern look with a bit of traditional feel, the Belgard Melville Plank paver is a great choice. It has the qualities of a modern paver with narrower width, which works great for more traditional homes that have modern landscape elements.',
          },
          {
            price: 3,
            'title': 'Calstone Linear',
            'url': 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/driveway/5c2d0aa6d038d9ffb6e4858c_paver%2520mod.jpg',
            'slug': 'the-calstone-linear-paver-is-everything-that-you-could-want-in-a-modern-paver-clean-minimal-an-attractive-array-of-gray-colors-with-the-high-quality-and-durability-that-calstone-offers-perfect-for-all-types-of-hard-surfaces-around-your-modern-home',
            'description': 'The Calstone Linear paver is everything that you could want in a modern paver: clean, minimal, an attractive array of gray colors with the high quality and durability that Calstone offers. Perfect for all types of hard surfaces around your modern home.',
          },
        ],
      },
    ],
    partners: [
      {
        ...
        imageSrc: 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/previews/pavers-1.jpg',
      },
      {
        name: 'Pavers',
        slug: 'pavers-2',
        url: 'https://calstone.com/paving-stones',
        imageSrc: 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/previews/pavers-2.jpg',
      },
      {
        name: 'Pebbles (Aggregates)',
        slug: 'pebbles-aggregates',
        url: 'https://www.zankerlandscapematerials.com/catalog/aggregates',
        imageSrc: 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/previews/pebbles-aggregates.jpg',
      },
      {
        name: 'Decorative Rock',
        slug: 'decorative-rock',
        url: 'https://evergreensupplyonline.com/decorative-rock/',
        imageSrc: 'https://ergeon-photo-gallery.s3-us-west-1.amazonaws.com/previews/decorative-rock.jpg',
      },
    ],
