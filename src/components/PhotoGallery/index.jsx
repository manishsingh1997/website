...
class PhotoGallery extends React.Component {
  ...
  renderPhotos() {
    ...
    return (
      <Masonry className="photo-gallery__masonry" ref={(ref) => (this.masonry = this.masonry || ref?.masonry)}>
        {!isEmpty(photos) &&
        ...
        <div className="photo-gallery">
          ...
          <div className="wrapper-1180">
            <div className="cards two-columns">
              {[BANNERS.FENCE_BANNER, BANNERS.GATE_BANNER, BANNERS.DRIVEWAY_BANNER].map((banner, index) =>
                this.renderBanner(banner, index)
              )}
            </div>
          </div>
        </div>
    ...
    return (
      <div className="photo-gallery">
        <div className="wrapper-1180">
          ...
          <h1 className="h2">
            {category?.categoryName} {activeGroup?.name} {this.getProductGalleryName()}
          </h1>
        </div>
